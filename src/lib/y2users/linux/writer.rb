  ...
  module Linux
    ...
    private
      ...
      def add_groups(issues)
        GroupsWriter.new(config, initial_config).add_groups(issues)
      end
      ...
      def add_users(issues)
        UsersWriter.new(config, initial_config).add_users(issues)
      end
      ...
      def edit_users(issues)
        UsersWriter.new(config, initial_config).edit_users(issues)
      end
    end
  end
end
