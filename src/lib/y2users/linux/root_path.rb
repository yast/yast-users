...
module Y2Users
  module Linux
    ...
    #
    # At the moment of writing, the shadow tools do not allow to set the exact location of the files.
    # Instead, they allow to define the path to what would be the root directory of a system. That
    # implies the tools always assume an extra ./etc directory within the provided path.
    #
